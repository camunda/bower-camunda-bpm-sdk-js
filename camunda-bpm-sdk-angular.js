...
},{"./../../forms/camunda-form":28,"./../../forms/constants":29}],2:[function(_dereq_,module,exports){
'use strict';
...
},{"./../../forms/type-util":35,"./camunda-form-angular":1}],3:[function(_dereq_,module,exports){
/** @namespace CamSDK */
...
},{"./../api-client":6,"./../utils":37,"./forms":2}],4:[function(_dereq_,module,exports){
'use strict';
  ...
  list: function(params, done) {
    ...
    return Q.all([countPromise, deferred.promise]).then(
      function() {
        ...
        // if an error occurs in the done function, we do not want the promise to be rejected
        // instead the error should propagate to the browser, we therefore have to create a new
        // execution context for the done function
        setTimeout(function(){done(null, results);});
    ...
    this.http.get(this.path +'/count', {
      data: params,
        ...
        if (err) {
          ...
          // instead the error should propagate to the browser, we therefore have to create a new
          // execution context for the done function
          setTimeout(function(){done(null, result.count);});
...
},{"./../base-class":26,"./../events":27,"q":43}],5:[function(_dereq_,module,exports){
(function (Buffer){
'use strict';
...
},{"./../events":27,"./../utils":37,"buffer":38,"q":43,"superagent":44}],6:[function(_dereq_,module,exports){
'use strict';
var Events = _dereq_('./../events');
...
},{"./../events":27,"./http-client":5,"./resources/authorization":7,"./resources/case-definition":8,"./resources/case-execution":9,"./resources/case-instance":10,"./resources/decision-definition":11,"./resources/deployment":12,"./resources/execution":13,"./resources/filter":14,"./resources/group":15,"./resources/history":16,"./resources/incident":17,"./resources/job":18,"./resources/metrics":19,"./resources/migration":20,"./resources/process-definition":21,"./resources/process-instance":22,"./resources/task":23,"./resources/user":24,"./resources/variable":25}],7:[function(_dereq_,module,exports){
'use strict';
...
},{"./../abstract-client-resource":4,"q":43}],22:[function(_dereq_,module,exports){
'use strict';
...
},{"./../abstract-client-resource":4,"q":43}],24:[function(_dereq_,module,exports){
'use strict';
...
},{"./../abstract-client-resource":4,"q":43}],25:[function(_dereq_,module,exports){
'use strict';
...
},{"./../base-class":26,"./../events":27,"./constants":29,"./controls/choices-field-handler":31,"./controls/file-download-handler":32,"./controls/input-field-handler":33,"./dom-lib":34,"./variable-manager":36}],29:[function(_dereq_,module,exports){
'use strict';
...
},{"./type-util":35}],37:[function(_dereq_,module,exports){
'use strict';
...
},{"./forms/type-util":35}],38:[function(_dereq_,module,exports){
/*!
...
},{"base64-js":39,"ieee754":40,"is-array":41}],39:[function(_dereq_,module,exports){
...
},{"FWaASH":42}],44:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"emitter":45,"reduce":46}],45:[function(_dereq_,module,exports){
