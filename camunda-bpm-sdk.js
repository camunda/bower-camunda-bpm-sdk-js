...
/**
 * Query for the number of history cleanup configuration
 */
...
/**
 * Query for the number of history cleanup job
 */
...
/**
 * Query for the number of report results about a process definition and finished process instances relevant to history cleanup
 * @param  {Object}      [params]
...
History.cleanableProcessInstanceCount = function(params, done) {
...
/**
 * Query for count of the finished historic process instances, cleanable process instances and basic process definition data - id, key, name and version
 * This method takes the same parameterers as 'History.cleanableProcessInstanceCount'
 */

History.cleanableProcessInstance = function(params, done) {
...
/**
 * Query for the number of report results about a case definition and finished case instances relevant to history cleanup
...
History.cleanableCaseInstanceCount = function(params, done) {
...
History.cleanableCaseInstance = function(params, done) {
...
/**
 * Query for the number of report results about a decision definition and finished decision instances relevant to history cleanup
 * @param  {Object}      [params]
...
History.cleanableDecisionInstanceCount = function(params, done) {
...
History.cleanableDecisionInstance = function(params, done) {
